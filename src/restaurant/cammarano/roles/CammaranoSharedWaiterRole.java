...
public class CammaranoSharedWaiterRole extends CammaranoBaseWaiter implements CammaranoWaiter {
	...
	// Default constructor
	public CammaranoSharedWaiterRole() {
		super();
		leaveTime = 40;
	...
	public void setPerson(Person p) {
		...
		for (PersonAgent.Job j : person.getJobs()) {
			if(j.getJob().equals("CammaranoSharedWaiterRole")) {
	...
	// Go to the cook
	private void GoToStand(CustomerHandler c) {
		print("Going to the revolving stand");
		...
		*/
		stand.addOrder(new CammaranoOrder(c.choice, this, c.table));
		cook.msgOrderOnTheStand();
