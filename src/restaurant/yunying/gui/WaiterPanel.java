...
public class WaiterPanel extends JPanel implements ActionListener {
    ...
    private JButton addWaiter = new JButton("AddWaiter");
     ...
     */
    public WaiterPanel(RestaurantGui gui, RestaurantPanel restPanel, String type) {
        restGui = gui;
        restP = restPanel;
        this.type = type;
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == addWaiter) {
            addWaiter(nameTextField.getText());
        }
        else {
    ...
    public void addWaiter(String name) {
        if (name != null) {
            ...
            restP.addWaiter(name);//puts customer on list
