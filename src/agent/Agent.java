...
public abstract class Agent {
	...
	Semaphore pauseHandler = new Semaphore(0, true);	// Semaphore that handles putting agents to sleep.
	
	private boolean pause = false;		// Boolean that handles when the pause semaphore is used.
