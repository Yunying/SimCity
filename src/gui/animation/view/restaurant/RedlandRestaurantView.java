 ...
 * @author CMCammarano
 */
public class RedlandRestaurantView extends BaseSceneView implements ActionListener {
	...
	public RedlandRestaurantView(AnimationPanel ap) {
		
		super(ap);
		
		// Setting the animation
		animation = ap;
		name = "Redland Restaurant View";
